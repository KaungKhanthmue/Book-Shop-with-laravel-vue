<template>
  <div class="bg-black h-[200px]">
        ...
        <div class="w-[95%] h-[180px] my-auto flex">
          <div class="w-[80%] pt-[20px]">
            ...
            <div class="w-[100%] flex">
              ...
              <div class="text-lg font-medium">Kaung Kaung</div>
            </div>
            <div class="w-[100%] flex">
            ...
            <div class="w-[100%] flex">
              ...
              <div class="text-lg font-medium">200</div>
            </div>
          </div>
          <div class="w-[20%]">
            <div class="pb-[10px]">
              <div class="voltage-button flex justify-center">
    ...
    <div class="container mx-auto h-[60px] bg-black mt-6 flex justify-around">
    <button role="button" class="button-name my-auto">Your Books</button>
        <button role="button" class="button-name my-auto">Your Save Books</button>
        <button role="button" class="button-name my-auto">You Liked Books</button>
        <button role="button" class="button-name my-auto">Your Follower List</button>
        <button role="button" class="button-name my-auto">You Following List</button>
    </div>
  </div>
</template>
<style scoped>
