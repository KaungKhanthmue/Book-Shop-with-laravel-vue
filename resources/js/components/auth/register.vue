  ...
  <div>
    <div id="Container">
      <form class="form" @submit.prevent='handleRegister'>
        ...
        <input class="form-content" v-model="form.name"  type="text" placeholder="UserName" />
        <input class="form-content" v-model="form.email" type="email" />
        <input class="form-content" v-model="form.password" type="password" placeholder="PassWord" />
